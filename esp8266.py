...
class ESP8266:
    ...
    def getAvailableAPs(self, allwifi, ssid):
        """
        This fucntion use to query ESP8266 for available WiFi AccessPoins
        
        Retuns:
            List of Available APs if allwifi is true, or a single wifi rssi if false
        """
        ...
        if(retData != None):
            ...
            if not allwifi:
                ...
                for item in apLists:
                    if item[1] == '"' + ssid + '"':
                        info = [ssid, item[2]]
                        # info = "Access Point: " + ssid + ", Signal strength: " + item[2]
                        return info
    ...
    def makeHotspot(self,ssid, pwd, ch = "1",ecn = "0"):
        """
        This function makes the hotspot to allow other devices to connect to the ESP8266.
        ...
        Parameters:
            ...
            ecn : 0 = OPEN
                    ...
                    4 = WPA_WPA2_PSK
        """    
        txData = "AT+CWSAP="+'"'+ssid+'"'+','+'"'+pwd+'"'+','+ch+','+ecn + "\r\n"
        print('Attempting to create hotspot')
        print('>', txData)
        retData = self._sendToESP8266(txData, delay=15)
        print('status:', retData)
        return retData

    def currentConnection(self):
        """
        This function returns the wifi info to which the ESP8266 is currently connected.
        ...
        txData = "AT+CWJAP?"
        retData = self._sendToESP8266(txData, delay = 10)
        return retData
